...
const Profile = ({ data, forName }) => {
    const AuthorData = data
    return (
        <div>
            <input type="checkbox" id={forName} className="modal-toggle" />
            <div className="modal">
                <div className="modal-box relative w-96">
                    <label htmlFor={forName} className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                    <div className='justify-center flex'>
                        <div className="bg-white">
                            <img className="object-cover object-center w-full h-56 rounded-t-3xl" src={AuthorData?.profilePicture||"/no-user.jpg"} alt="avatar" />
                            <div className="flex items-center px-3 py-3 bg-gray-900 rounded-b-3xl">
                                <div className="flex w-full">
                                    <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md">
                                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a1 1 0 00-1 1v1a1 1 0 002 0V3a1 1 0 00-1-1zM4 4h3a3 3 0 006 0h3a2 2 0 012 2v9a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm2.5 7a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm2.45 4a2.5 2.5 0 10-4.9 0h4.9zM12 9a1 1 0 100 2h3a1 1 0 100-2h-3zm-1 4a1 1 0 011-1h2a1 1 0 110 2h-2a1 1 0 01-1-1z" clipRule="evenodd"></path></svg>
                                    </span>
                                    <input disabled readOnly type="text" id="website-admin" className="w-full rounded-none rounded-r-lg border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={AuthorData?._id} />
                                    <button className='m-1' onClick={() => { navigator.clipboard.writeText(AuthorData?._id) }}>
                                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z"></path><path d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z"></path></svg>
                                    </button>
                                </div>
                            </div>

                            <div className="py-4">
                                <h1 className="text-xl font-semibold text-gray-800 ">{AuthorData?.username}</h1>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 ">
                                    ...
                                    <h1 className="px-2 text-sm">Akash Mondal</h1>
                                </div>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 ">
                                    ...
                                    <h1 className="px-2 text-sm">Calcutta</h1>
                                </div>
                                ...
                                <div className="flex items-center mt-4 text-gray-700 ">
                                    ...
                                    <h1 className="px-2 text-sm">{AuthorData?.email}</h1>
                                </div>
                            </div>
                        </div>
